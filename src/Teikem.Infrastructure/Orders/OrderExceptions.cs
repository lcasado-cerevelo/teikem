...
/// serializa: el front arma el modal 'Crear de todos modos' sin parsear el título.
/// </summary>
public sealed class DuplicateInvoiceException : TeikemException
{
        ...
        : base(message, 409, confirmable ? ConfirmableCode : BlockedCode)
    {
        ...
        {
            ["clientInvoiceNumber"] = new[] { message },
            ["existingOrderNumber"] = new[] { existingOrderNumber },
            ["existingOrderPublicId"] = new[] { existingOrderPublicId.ToString() },
        };
    }
